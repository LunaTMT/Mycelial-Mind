...
const SortDropdown: React.FC<SortDropdownProps> = ({ setSortOption }) => {
    ...
    return (
        <div
            ...
            ref={dropdownRef}
        >
            <p className="font-Poppins text-slate-700 hover:text-black dark:text-slate-300 dark:text-white/70 dark:hover:text-white">SORT</p>
            <ArrowIcon w="30" h="30" isOpen={showDropdown} />
            <ul
                className={`absolute right-0 top-14 w-[250%] bg-white dark:bg-gray-800 shadow-lg rounded-md border border-black/20 dark:border-gray-600 z-40 
