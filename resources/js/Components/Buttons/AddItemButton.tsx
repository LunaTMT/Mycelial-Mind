        ...
        userRole === 'admin' && (
            <Link href={route('item.add')}>
                <div className="cursor-pointer flex items-center justify-center gap-2 rounded-md relative group">
                    <p className="font-Poppins text-slate-700 hover:text-black dark:text-slate-300 dark:text-white/70 dark:hover:text-white transition-transform duration-300 ">
                        ADD
                    </p>
